...
The mean total steps per day is: `r meanTotalSteps` and the median total steps
per day is: `r medianTotalSteps`.
...
`r stepMissing`, which is `r percentMissing`% of the data set.
...
The mean steps per day for the completed data set is: `r meanCompleteSteps`. 
Compare this to the mean steps per day for the data set that includes missing
data: `r meanTotalSteps`. The median steps per day for the completed data set is:
`r medianCompleteSteps`. Compare this to the median steps per day for the data
set that includes missing data: `r medianTotalSteps`. As you can see, using the 
